...
pub const LINK_DOCS_HOME: &str = "221.208.250.35";
pub const LINK_DOCS_X11_REQUIRED: &str = "221.208.250.35";
...
pub const RS_PUB_KEY: &str = "WZvpAvQcQXGgZ1qqq8XPAeM3CnpAk8pixspAfKteJwU=";
